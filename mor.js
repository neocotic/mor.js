...
(function (root) {
  ...
  function prepare(str, wordSplitter, letterSplitter, charSplitter) {
    ...
    var
      hasCharSplitter = typeof charSplitter !== 'undefined',
